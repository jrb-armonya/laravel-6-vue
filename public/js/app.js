...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    bodyClicked: function bodyClicked(event) {
      alert('BODY CLICKED');
      console.log(event);
    },
    ulClicked: function ulClicked(event) {
      alert('UL CLICKED');
    }
  },
  mounted: function mounted() {
    ...
    // alert(this.prenom)
    axios.get('users/' + this.id).then(function (data) {
...
__webpack_require__(/*! /home/jrb-armonya/www/Laravel-6/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/jrb-armonya/www/Laravel-6/resources/sass/app.scss */"./resources/sass/app.scss");
